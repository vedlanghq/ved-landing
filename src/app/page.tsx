              ...
              <pre>
                <code>
                  <span className="token-comment">
                    // Domain-Oriented State Isolation
                  </span>
                  {"\n"}
                  <span className="token-keyword">domain</span>{" "}
                  <span className="token-entity">AutoScaler</span> {"{"}
                  {"\n"}
                  {"    "}
                  ...
                  <span className="token-entity">MaintainCapacity</span> {"{"}
                  {"\n"}
                  {"        "}
                  <span className="token-keyword">target</span> replicas{" "}
                  <span className="token-operator">==</span>{" "}
                  <span className="token-property">5</span>
                  {"\n"}
                  {"        "}
                  ...
                  {"\n"}
                  {"            "}replicas{" "}
                  <span className="token-operator">=</span> replicas{" "}
                  <span className="token-operator">+</span>{" "}
                  ...
                  {"\n\n"}
                  {"    "}
                  <span className="token-keyword">on goal</span>{" "}
                  MaintainCapacity <span className="token-keyword">when</span>{" "}
                  replicas <span className="token-operator">&lt;</span>{" "}
                  <span className="token-property">5</span> {"{"}
                  {"\n"}
                  {"        "}
                  <span className="token-keyword">send self</span> ScaleUp{"\n"}
                  {"    "}{"}"}
                  {"\n"}
                  {"}"}
                </code>
