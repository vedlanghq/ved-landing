...
Because they are mathematically pure, the Ved runtime can efficiently evaluate the satisfaction of all goals after _every single state mutation_ without performance degradation.
