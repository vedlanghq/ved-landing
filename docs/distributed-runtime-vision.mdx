...
Because Ved's type system natively understands _Authority Scopes_ (e.g., Tenant > Environment > Workspace > Target), the distributed scheduler can enforce physical data locality based on logical authority.
