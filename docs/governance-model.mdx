...
Lexum is governed by the **Lexum Core Philosophy Team**.

Because Lexum is trying to solve a mathematically strict, highly opinionated architectural problem (Deterministic Execution and Authority Boundaries), the project does not accept feature requests simply because "other languages do it."
