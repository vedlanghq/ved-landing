...
Lexum is currently in the **Foundational Research and v0.1 Build Phase**. Our goal is not to ship a massive, bloated standard library, but to perfectly execute the core architectural invariants (Determinism, Authority Typing, and Asynchronous Mailboxing).
