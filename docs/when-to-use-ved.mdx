...
Ved is a specialized general-purpose language. While you _could_ write anything in it, its architectural constraints are heavily optimized for specific domains where reliability, convergence, and auditability are non-negotiable.
