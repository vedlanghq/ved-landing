...
Lexum schedulers are designed as swappable, formal plugins. You can compile the runtime with a custom Scheduler Policy written in Rust that implements the `ved_scheduler_interface`.
