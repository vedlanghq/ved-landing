...
If a Ved compilation yields a Warning, the code _will_ execute, but the compiler possesses mathematical evidence that the state machine could enter an unresolvable degradation loop.
